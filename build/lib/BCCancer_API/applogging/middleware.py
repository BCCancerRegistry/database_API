...
from BCCancerAPI.applogging.config import logging_config
...
class RouterLoggingMiddleware(BaseHTTPMiddleware):
    ...
    async def _log_response(self,
        ...
        #Commenting to reduce the log size. Only uncomment to identify if there is an issue with response
